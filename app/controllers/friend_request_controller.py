...
class FriendRequestController:
    ...
    async def update_request_status(self, request_id, status: str, user_service: UserService):
        await self.friend_request_service.update_request_status(request_id, status, user_service)
